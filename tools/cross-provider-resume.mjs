...
//                            slice landed: task done, test green, doctor
...
export const RESUME_PROMPT = [
  ...
  'Resume the in-progress task exactly as the spec describes it, using red/green TDD: write the failing',
  'test first, run it and observe the failure, implement the smallest change, run it green.',
  'Then close the task with the spec tool (proof, docs, remaining-gap), render, run doctor, commit with a',
