...
- `templates/ADOPTION.md:80-87` (Phase 0 step 1) requires confirming the
...
- `skills/update-harness/SKILL.md:186` makes the completion criterion "project
