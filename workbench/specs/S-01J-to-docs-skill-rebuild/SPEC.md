...
**Next gate:** Review this skill's existing behavior, then activate TK-01A for this skill only.
...
|---|---|---|---|---|
| TK-01A | Audit to-docs, deliver the smallest supported source/documentation change and prove the routed article | ready | none | pending |
