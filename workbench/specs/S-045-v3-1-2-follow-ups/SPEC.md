...
> **Citation anchors.** pre=`18ffc0d` post=`2dbc9a7`. A bare `path:line` citation
...
written and went stale the same afternoon; the withdrawal is the last evidence
row. It is named here rather than left in the log because the row that carried
