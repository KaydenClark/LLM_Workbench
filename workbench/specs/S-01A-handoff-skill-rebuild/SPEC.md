...
**Next gate:** Review this skill's existing behavior, then activate TK-00R for this skill only.
...
|---|---|---|---|---|
| TK-00R | Audit handoff, deliver the smallest supported source/documentation change and prove the routed article | ready | none | pending |
