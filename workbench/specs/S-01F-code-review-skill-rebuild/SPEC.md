...
**Next gate:** Review this skill's existing behavior, then activate TK-00W for this skill only.
...
|---|---|---|---|---|
| TK-00W | Audit code-review, deliver the smallest supported source/documentation change and prove the routed article | ready | none | pending |
