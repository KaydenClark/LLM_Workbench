...
**Stance:** Reconciler
**Planned verification:** Red: the batch matrix finds Blueprint/ADR routing, Template, evidence intake, Genesis, fresh-project, release-gate or Lexicon-freshness meaning readable only from one of the seven Specs; green: the product journey is capability-shaped and current, release readiness still belongs to S-00O, consumers are redirected, and the approved batch retires without copying project state into the Wiki.
