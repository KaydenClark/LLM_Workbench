...
**Blockers:** TT-Q10 (identifier form) is the owner gate: with TK-001, TK-002 and TK-008 landed it is the only thing between this Spec and `complete` once TK-005 and TK-006 land, because TK-003, TK-004 and therefore TK-007 wait on it. Options recorded in the 2026-09-17 TT-Q10 evidence row.
**Latest event:** TK-006 claimed by DISPATCHER.
