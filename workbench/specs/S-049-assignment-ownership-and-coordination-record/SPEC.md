...
That is the honest headline for a spec about measuring what a run costs the
owner: this one cost the owner nothing live, and still shipped two false
statements that only an independent reader caught.
