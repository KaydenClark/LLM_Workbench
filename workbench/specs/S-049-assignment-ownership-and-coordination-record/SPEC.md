...
- [ ] All six documents that state the bundle size - `skills/README.md`,
...
- [ ] Every documented `--version` literal equals the checkout release, and a
      test holds it there. `RUNBOOK.md`'s Genesis command runs.
- [ ] The layout suite proves a v3.1.1 manifest and a v3.1.2 manifest both stay
