...
**Blockers:** none
**Latest event:** Fourth separate-context review found the coverage repair undefeatable across 32 mutation shapes and blocked only on one shipped-tree line number, corrected here.
