...
| TK-004 | Document both mechanisms in their control owners | ready | none | `AGENTS.md` and `RUNBOOK.md` updated; `tools/test-control-fidelity.mjs` and the full suite pass |
