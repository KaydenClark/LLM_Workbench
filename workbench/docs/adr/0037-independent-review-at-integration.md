...
# Require independent review when branches combine at integration

A proposed integration candidate triggers separate-context review of the immutable candidate and its evidence before branches combine. Earlier review and verification support delivery without mandatory independence per ticket.

Considered and rejected: Independent review of every intermediate change duplicates the final gate and creates unnecessary stops.
