...
| Cross-agent discovery and skill-catalog release input | discovery links and S-011 evidence | unresolved owner decision for Claude auth plus settled catalog work | [S-011](../specs/S-011-agent-skills-adoption/SPEC.md) owns its component schema, TK-003, and TK-016; S-018 owns manifest/rollout | covered; owner gate explicit |
...
| Deterministic release manifest | public package inventory, update skill, and S-011 catalog boundary | settled but not implemented and missing a spec | [S-018](../specs/S-018-versioned-delivery-rollout/SPEC.md) TK-002 and TK-004 consume completed S-011 | covered |
