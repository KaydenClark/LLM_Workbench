...
| Escape-safe Markdown table persistence | merged PR #33 source/tests | implemented under a one-time release spec | [S-014](../specs/S-014-workbench-release-candidate/SPEC.md) evidence; S-001 lifecycle contract | covered |
...
| Cross-agent fresh discovery and downstream skill packaging | discovery links and S-011 evidence | unresolved owner decision for Claude auth plus settled rollout work | [S-011](../specs/S-011-agent-skills-adoption/SPEC.md) TK-003 and TK-016 | covered; owner gate explicit |
...
| Deterministic release manifest | public package inventory and update skill | settled but not implemented and missing a spec | [S-018](../specs/S-018-versioned-delivery-rollout/SPEC.md) TK-002 | covered |
