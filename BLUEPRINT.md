...
| [S-045 - v3.1.2 Follow-Ups Left Without An Owner](workbench/specs/S-045-v3-1-2-follow-ups/SPEC.md) | Own the three follow-ups the v3.1.2 slices recorded and could not close, so owed work is reachable from `next` instead of surviving only as prose in completed specs. | active |
<!-- spec-catalog:end -->
