...
| [S-041 - Recorded Baseline Availability](workbench/specs/S-041-recorded-baseline-availability/SPEC.md) | Decide and record what a harness-only migration does when the target has no runnable green baseline, so eight rooms blocked by an unrelated product or host condition get one answer instead of eight improvised ones. | active |
