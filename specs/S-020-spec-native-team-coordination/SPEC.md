...
**Blockers:** none
**Latest event:** Canon harvest identified the tracked team templates as contradictory to the v2.3 spec lifecycle.
**Next gate:** Claim TK-001 and replace the manager contract without changing runtime tooling.
...
|---|---|---|---|---|
| TK-001 | Rewrite the manager template around Captain, roles, one owning spec, and one writer | ready | none | pending |
