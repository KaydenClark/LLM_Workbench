# [PROJECT_NAME] - Hot Taskboard

> Generated from LLM Workbench v[HARNESS_VERSION].

**Current focus:** [current useful outcome]
**Owner:** [executive owner; execution owner]
**Last updated:** [YYYY-MM-DD]

This is an active execution projection, not a requirements store or proof
archive. Use `[SPEC_NEXT_COMMAND]` to select work and load only its linked spec.
...
|---|---|---|---|---|---|---|
| [S-###] | [product tradeoff] | [A / B] | [choice + why] | [cost/risk] | [owner] | [decision gate] |
