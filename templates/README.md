...
For **Claude Code**, add a `CLAUDE.md` beginning with `@AGENTS.md` and direct
links to `BLUEPRINT.md`, `LEXICON.md`, `TASKBOARD.md`, `RUNBOOK.md`, and
`MEMORY.md`, or run `/init` in this repo and add those links afterward. Other
agents should be pointed at `AGENTS.md` as their entry point.
