...
| [S-025](workbench/specs/S-025-portable-wiki-and-design-concepts/SPEC.md) | TK-003: Lexicon routing and the product repository's own wiki adopt the contract with an empty design-concepts collection (ready) | claude-fable-5-1 | TK-002 | TK-002 closed with proof. | Complete TK-003. |
