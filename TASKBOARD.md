...
| [S-015](workbench/specs/S-015-portable-v3-release-audit-recovery/SPEC.md) | TK-001: A cold Genesis project gets only manifest-routed controls and fails closed unless its controls and first spec are operable (ready) | unassigned | none | S-014's immutable `d80d14c` release audit rejected the candidate on stale template paths, permissive Genesis validation, and stale limitation accounting. | Claim TK-001 and drive the rejected public seams red/green. |
<!-- hot-specs:end -->
