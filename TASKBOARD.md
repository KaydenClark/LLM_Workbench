...
| [S-047](workbench/specs/S-047-visible-workbench-identifiers/SPEC.md) | TK-001: Allocate and retrieve one new visible notepad ID through a tested CLI while legacy numeric records still resolve (in-progress) | codex | none | TK-001 claimed by codex. | Close TK-001 with verification and documentation proof. |
