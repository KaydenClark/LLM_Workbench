...
| [S-048](workbench/specs/S-048-checkpoint-retirement/SPEC.md) | TK-001: Trace one checkpoint from original rationale through inbound references and reconcile it to a proposed disposition with a checkable continuation example (in-progress) | codex | none | TK-001 claimed by codex. | Close TK-001 with verification and documentation proof. |
