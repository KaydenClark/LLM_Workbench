...
|---|---|---|---|---|---|
| [S-017](specs/S-017-controlled-outcome-measurement/SPEC.md) | TK-004: Execute the preregistered repeated real-agent comparison (blocked) | codex-engineer | TK-003, owner model/API spend approval | TK-003 closed with proof. | Complete TK-004. |
