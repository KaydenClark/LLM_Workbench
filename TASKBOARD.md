...
| [S-031](workbench/specs/S-031-installed-skill-generation/SPEC.md) | TK-002: Report formats require naming the copy read; sessions ignore denies `grilling diary/` losslessly (ready) | claude-fable-5-1 | TK-001 | TK-001 closed with proof. | Complete TK-002. |
