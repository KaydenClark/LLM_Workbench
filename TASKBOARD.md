...
| [S-050](workbench/specs/S-050-workbench-v3-2-0-release/SPEC.md) | TK-003: Converge capability implementations and useful continuity proof (ready) | codex | live-device-and-private-repository-access (final rollout readiness only) | Local capability work and useful native continuation verified; external acceptance gates remain. | Complete S-053 local conformance, verify v3.2.0 and integrate the upstream update. |
