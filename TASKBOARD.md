...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-006: Repair reviewed discovery chronology, safe discovery paths and decoded-field privacy before using the candidate (in-progress) | codex | TK-002 | TK-006 claimed by codex. | Close TK-006 with verification and documentation proof. |
