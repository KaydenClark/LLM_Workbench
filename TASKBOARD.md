...
| [S-045](workbench/specs/S-045-v3-1-2-follow-ups/SPEC.md) | TK-002: Emit `stale-seed` and `unverified-provenance` from a seam whose scope matches what they report (ready) | claude | TK-005 | TK-001 closed with proof. | Complete TK-002. |
