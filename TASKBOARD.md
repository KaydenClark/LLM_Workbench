...
| [S-045](workbench/specs/S-045-v3-1-2-follow-ups/SPEC.md) | TK-001: Make the presence-only gates and the installer agree on a linked skill destination, or record which is authoritative (ready) | claude | TK-005 | TK-005 closed with proof. | Complete TK-001. |
