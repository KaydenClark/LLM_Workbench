...
| [S-050](workbench/specs/S-050-workbench-v3-2-0-release/SPEC.md) | TK-004: Verify and integrate the immutable upstream v3.2.0 candidate (ready) | codex | TK-003 | Local capability work and useful native continuation verified; external acceptance gates remain. | Resolve S-053 owner capability agreement and S-052 actual private repository/device access before final convergence. |
