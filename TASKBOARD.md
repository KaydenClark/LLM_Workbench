...
|---|---|---|---|---|---|
| [S-017](specs/S-017-controlled-outcome-measurement/SPEC.md) | TK-003: Aggregate multiple tasks into an uncertainty-aware no-spend report (in-progress) | codex-engineer | none | TK-003 implementation and no-spend fixture proof are green at a local checkpoint. | Push the immutable TK-003 checkpoint and run the exact-head Auditor before close. |
