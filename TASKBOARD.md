...
| [S-023](workbench/specs/S-023-manifest-schema-2-and-managed-runtime/SPEC.md) | TK-001: A schema 2 manifest with six lanes and seven collections validates, a schema 1 manifest reports `upgrade-required`, and `migrate` converts the product repository losslessly (in-progress) | claude-fable-5-1 | none | TK-001 claimed by claude-fable-5-1. | Close TK-001 with verification and documentation proof. |
| [S-024](workbench/specs/S-024-governance-core-adrs-and-diagnostics/SPEC.md) | TK-001: Doctor reports registered findings with effects, exits only on `all`/`selection`, and `next`/`claim` refuse slice blockers while attention stays visible (ready) | claude-fable-5-1 | S-023 | Spec captured from the promoted v3.1 plan. | Claim TK-001 after S-023/TK-001 lands. |
| [S-025](workbench/specs/S-025-portable-wiki-and-design-concepts/SPEC.md) | TK-001: The wiki template set seeds a validated project wiki with the required collections and profile during Genesis (ready) | claude-fable-5-1 | S-023 | Spec captured from the promoted v3.1 plan. | Claim TK-001 after S-023/TK-001 lands. |
| [S-026](workbench/specs/S-026-workflow-composition-and-cold-resume/SPEC.md) | TK-001: The twelve skills resolve tools, notepads, handoffs, and checkpoints through the manifest, and `sessions.mjs checkpoint` promotes a privacy-checked copy (ready) | claude-fable-5-1 | S-023 | Spec captured from the promoted v3.1 plan. | Claim TK-001 after S-023/TK-002 lands. |
<!-- hot-specs:end -->
