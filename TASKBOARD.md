...
| [S-030](workbench/specs/S-030-permission-scope-matches-lanes/SPEC.md) | TK-002: `permission-scope-drift` in doctor and the Genesis gate, with the conservative glob matcher (ready) | claude-fable-5-1 | TK-001 | TK-001 closed with proof. | Complete TK-002. |
