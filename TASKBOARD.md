...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-004: Migrate live JSON layout and ship schema/examples through managed installation without moving legacy sources (in-progress) | codex | TK-006 | TK-004 claimed by codex. | Close TK-004 with verification and documentation proof. |
