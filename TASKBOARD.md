...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-003: Preserve context before conversation interruption and trim only reconciled material through controls and source skills (in-progress) | codex | TK-001 | TK-003 claimed by codex. | Close TK-003 with verification and documentation proof. |
