...
| [S-036](workbench/specs/S-036-v3-1-2-evidence-corrections/SPEC.md) | TK-002: Make placeholder fills preserve fixed wording and prove the shipped ADR ownership row detects a removed qualifier in JSON and Markdown (blocked) | codex-gpt-5 | TK-001 | TK-001 closed with proof. | Complete TK-002. |
<!-- hot-specs:end -->
