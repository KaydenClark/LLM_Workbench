...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-003: Replace Ticket with Task across tool vocabulary and board columns (blocked) | DISPATCHER | TK-002, TT-Q10 | TK-006 closed with proof; five of eight slices landed; the remaining three are gated on TT-Q10. | Owner answers TT-Q10 (`T-###` or `TASK-###`); then flip TK-003 to `ready` and `claim S-00H` takes it. S-00I and S-00J stay `blocked` until this Spec is `complete`. |
