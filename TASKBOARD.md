...
| [S-027](workbench/specs/S-027-workbench-v3-1-1-boundaries/SPEC.md) | TK-001: Build and verify v3.1.1 route and stances, run Round One, then deliver feedback reporting and continuation (in-progress) | codex | none | TK-001 claimed by codex. | Close TK-001 with verification and documentation proof. |
<!-- hot-specs:end -->
