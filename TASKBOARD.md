...
| [S-042](workbench/specs/S-042-installed-state-repair/SPEC.md) | Acceptance / owner gate | unassigned | none | A separate-context review passed every adversarial probe of the behavior and rejected the records: six record-accuracy and documentation-ownership repairs are appended, `templates/wiki/SCHEMA.md` is brought level with its installed counterpart, and no shipped behavior changed. | Independent review of the exact candidate, then merge into `integration`. |
