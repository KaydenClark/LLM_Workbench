...
| [S-049](workbench/specs/S-049-assignment-ownership-and-coordination-record/SPEC.md) | TK-001: `/carry` exists as a discoverable core skill and the seventeen-skill bundle validates end to end without redefining any frozen legacy policy (in-progress) | claude | none | Owner unblocked TK-001: the seventeen-skill bundle is v3.1.3 and v3.1.2 is frozen at sixteen. | Close TK-001 with the full suite green at v3.1.3; TK-002 waits on a real assignment. |
