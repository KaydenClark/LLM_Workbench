...
| [S-024](workbench/specs/S-024-governance-core-adrs-and-diagnostics/SPEC.md) | TK-003: Root and template controls carry the Governance Core, and the product corpus holds the reconciled ported and new ADRs with valid `canonicalized_in` links (ready) | claude-fable-5-1 | TK-002 | TK-002 closed with proof. | Complete TK-003. |
| [S-025](workbench/specs/S-025-portable-wiki-and-design-concepts/SPEC.md) | TK-001: The wiki template set seeds a validated project wiki with the required collections and profile during Genesis (ready) | claude-fable-5-1 | none | Spec captured from the promoted v3.1 plan. | Claim TK-001 after S-023/TK-001 lands. |
