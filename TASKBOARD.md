...
| [S-00A](workbench/specs/S-00A-blueprint-active-adr-and-context-map/SPEC.md) | TK-00A: Validate active ADR lifecycle and render active/history projections (ready) | codex | none | Locked Blueprint and ADR decisions are durably reconciled below; active-ADR lifecycle mechanics and complete claim disposition remain to implement. | Claim TK-00A and add the failing ADR lifecycle/register cases before changing tooling. |
...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-007: Repair confirmed basename/sequence regressions and continuity gates (ready) | codex | none | TK-005 closed with proof. | Reproduce reported privacy/sequence regressions, repair confirmed defects, then verify capture boundaries with S-051. |
...
| [S-051](workbench/specs/S-051-core-skill-ownership-and-compatibility/SPEC.md) | TK-004: Repair scope-preserving core composition, handoff, routing and evidence review (ready) | codex | none | Owner activated the bounded coherence repair and recoverable global core migration; prior TK-001 through TK-003 evidence remains unchanged. | TK-004 composition repair, then reviewed migration and ordinary-prompt host acceptance. |
