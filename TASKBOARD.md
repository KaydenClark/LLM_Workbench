...
| [S-036](workbench/specs/S-036-v3-1-2-evidence-corrections/SPEC.md) | TK-004: Reconcile current ownership prose, run the full release gate, independently review the immutable candidate, and land it on `integration` (in-progress) | codex-gpt-5 | TK-003 | Review of `bfd84b4` confirmed the code fixes and found four stale descriptions of the tools-lane rule; all are aligned and focused green at `7e0f3c4`. | Rerun the full release gate and obtain fresh independent approval of the fully aligned exact candidate. |
<!-- hot-specs:end -->
