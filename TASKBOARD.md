...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-002: One agent saves an objective finding with a correction, then a fresh reader retrieves only that topic through the shared skill, schema, and CLI (in-progress) | claude-opus-5 | TK-001 | TK-002 claimed by claude-opus-5. | Close TK-002 with verification and documentation proof. |
<!-- hot-specs:end -->
