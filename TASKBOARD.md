...
| [S-00L](workbench/specs/S-00L-lexicon-freshness-repair/SPEC.md) | TK-001: Refresh the three stale Lexicon claims and record the bounded manual self-check (in-progress) | claude | none | TK-001 claimed by claude. | Close TK-001 with verification and documentation proof. |
