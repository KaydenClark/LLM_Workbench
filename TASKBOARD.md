...
| [S-048](workbench/specs/S-048-checkpoint-retirement/SPEC.md) | TK-003: Freeze checkpoint history and migrate active recovery consumers without breaking rollback (in-progress) | codex | TK-002 | TK-003 claimed by codex. | Close TK-003 with verification and documentation proof. |
