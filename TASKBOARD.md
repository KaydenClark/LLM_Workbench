...
| [S-027](workbench/specs/S-027-workbench-v3-1-1-boundaries/SPEC.md) | TK-001: Build and verify v3.1.1 route and stances, run Round One, then deliver feedback reporting and continuation (blocked) | codex | owner push approval | Independent review found one stale Lexicon claim; corrected locally with adjacent stale adoption wording. | Obtain explicit push approval after corrected-candidate review, then verify remote recovery. A full integration comparison remains required before merge. |
<!-- hot-specs:end -->
