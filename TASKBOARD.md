...
| [S-021](specs/S-021-portable-workbench-v3/SPEC.md) | TK-003: Adoption migrates one mixed existing project to v3 without losing records, history, project truth, or existing user skills (in-progress) | codex | TK-002 | TK-003 claimed by codex. | Close TK-003 with verification and documentation proof. |
