...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-006: Write the append-only per-run Receipt (in-progress) | DISPATCHER | TK-001 | TK-005 closed with proof. | Complete TK-003. |
