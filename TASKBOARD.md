...
| [S-048](workbench/specs/S-048-checkpoint-retirement/SPEC.md) | TK-002: Promote selected safe material directly into its durable owner with verified read-back before source cleanup (in-progress) | codex | TK-001 | TK-002 claimed by codex. | Close TK-002 with verification and documentation proof. |
