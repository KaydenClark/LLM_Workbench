...
| [S-036](workbench/specs/S-036-v3-1-2-evidence-corrections/SPEC.md) | TK-004: Reconcile current ownership prose, run the full release gate, independently review the immutable candidate, and land it on `integration` (in-progress) | codex-gpt-5 | TK-003 | The corrected candidate passed the complete release gate and retained the 78/100 guardrail score with no new outcome claim. | Push the exact candidate and obtain fresh independent approval before opening and merging its PR to `integration`. |
<!-- hot-specs:end -->
