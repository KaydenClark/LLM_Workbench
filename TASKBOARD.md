...
| [S-038](workbench/specs/S-038-v3-1-2-upstream-fix-list/SPEC.md) | TK-001: Record the owner's acceptance or amendment of the routing and the answers to the three open questions (ready) | claude-opus-5 | none | All eleven items re-verified against `b3633e5`; two upstream claims corrected; six capability specs opened; three owner questions carried forward. | Owner accepts or declines the routing below and answers the three open questions, in particular UP-017 which blocks S-041. |
...
| [S-041](workbench/specs/S-041-recorded-baseline-availability/SPEC.md) | TK-001: Write the chosen contract into `templates/ADOPTION.md`, `skills/update-harness/SKILL.md`, and the spec record shape, with a fixture proving the recorded state is honored and cannot be used to report red as green (blocked) | unassigned | owner decision | Spec captured from upstream item UP-017; the contract question is open and is stated as an owner gate. | Owner answers the contract question in Decisions And Contracts; TK-001 is blocked until then. |
