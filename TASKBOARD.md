...
| [S-027](workbench/specs/S-027-workbench-v3-1-1-boundaries/SPEC.md) | TK-001: Build and verify v3.1.1 route and stances, run Round One, then deliver feedback reporting and continuation (in-progress) | codex | none | v3.1.1 local candidate passes the full 29-command suite, Round One and fresh continuation. | Review the immutable local v3.1.1 candidate; obtain explicit approval to push, then verify the remote SHA. |
<!-- hot-specs:end -->
