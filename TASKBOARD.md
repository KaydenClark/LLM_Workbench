...
| [S-050](workbench/specs/S-050-workbench-v3-2-0-release/SPEC.md) | TK-004: Verify and integrate the immutable upstream v3.2.0 candidate (in-progress) | codex | TK-003 | TK-004 claimed by codex. | Close TK-004 with verification and documentation proof. |
