...
| [S-00P](workbench/specs/S-00P-workflow-canon-rework/SPEC.md) | TK-001: Rewrite `BLUEPRINT.md` against every rung and the full recursive loop (in-progress) | DISPATCHER | TK-002 onward wait on S-00H, S-00I and S-00J reaching `complete`; TK-001 is unblocked. | TK-001 claimed by DISPATCHER. | Close TK-001 with verification and documentation proof. |
...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-001: Introduce `TASK.md` as a record with its own state and blockers (in-progress) | DISPATCHER | TT-Q10 (identifier form) is open and blocks TK-003 and TK-004. | TK-001 claimed by DISPATCHER. | Close TK-001 with verification and documentation proof. |
