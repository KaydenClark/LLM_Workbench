...
| [S-049](workbench/specs/S-049-assignment-ownership-and-coordination-record/SPEC.md) | TK-001: `/carry` exists as a discoverable core skill and the seventeen-skill bundle validates end to end without redefining any frozen legacy policy (in-progress) | claude | none | TK-001 claimed by claude; `carry` written and the bundle grown to seventeen. | Close TK-001 with the full suite green; TK-002 waits on a real assignment to carry. |
