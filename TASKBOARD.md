...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-003: Replace Ticket with Task across tool vocabulary and board columns (in-progress) | DISPATCHER | TK-002 | TK-003 claimed by DISPATCHER. | Close TK-003 with verification and documentation proof. |
