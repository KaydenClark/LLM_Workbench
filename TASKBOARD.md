...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-002: One agent saves an objective finding with a correction, then a fresh reader retrieves only that topic through the shared skill, schema, and CLI (ready) | codex | TK-001 | TK-003 closed with proof. | Complete TK-002. |
| [S-045](workbench/specs/S-045-v3-1-2-follow-ups/SPEC.md) | TK-001: Make the presence-only gates and the installer agree on a linked skill destination, or record which is authoritative (ready) | claude | TK-005 | The owner unblocked the remaining six for v3.1.3 and sequenced TK-005 first. | Complete TK-005. |
| [S-049](workbench/specs/S-049-assignment-ownership-and-coordination-record/SPEC.md) | TK-002: One real assignment is carried under `/carry`, and its hand-backs - or the recorded absence of any - are the first measurement (ready) | claude | none | TK-001 closed with proof. | Complete TK-002. |
<!-- hot-specs:end -->
