...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-002: Migrate selection, claim, close and render onto Task records (in-progress) | DISPATCHER | TK-001 | TK-005 claimed by DISPATCHER. | Close TK-005 with verification and documentation proof. |
