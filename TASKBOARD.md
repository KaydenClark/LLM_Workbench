...
| [S-036](workbench/specs/S-036-v3-1-2-evidence-corrections/SPEC.md) | TK-003: Fail closed on unverified source identity across layout, adoption, runtime-tool receipts, and skill markers, then rehearse v3.1.1 -> v3.1.2 maintenance preservation (ready) | codex-gpt-5 | TK-002 | TK-002 closed with proof. | Complete TK-003. |
<!-- hot-specs:end -->
