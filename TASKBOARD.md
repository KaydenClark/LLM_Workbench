...
| [S-022](workbench/specs/S-022-llm-workbench-v3-1-release/SPEC.md) | TK-003: Run the portability and privacy matrix on the exact candidate and record every result (ready) | claude-fable-5-1 | S-023, S-024, S-025, S-026 | TK-002 closed with proof. | Complete TK-003. |
<!-- hot-specs:end -->
