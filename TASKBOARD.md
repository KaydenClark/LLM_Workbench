...
| [S-021](specs/S-021-portable-workbench-v3/SPEC.md) | TK-006: LLM Workbench dogfoods v3, completes the fresh/cold acceptance matrix, and hands the exact integration candidate back to S-014 (ready) | codex | TK-005 | TK-005 closed with proof. | Complete TK-006. |
