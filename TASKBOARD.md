...
| [S-032](workbench/specs/S-032-upgrade-route-and-source-provenance/SPEC.md) | TK-002: `upgrade --layout-only` runs the layout phase without skill replacement; skill and protocol text name the route (ready) | claude-fable-5-1 | TK-001 | TK-001 closed with proof. | Complete TK-002. |
