...
| [S-00C](workbench/specs/S-00C-project-evidence-and-blueprint-grilling/SPEC.md) | TK-00D: Collect bounded evidence and prepare a Blueprint grilling record (ready) | codex-v321-manager | none | Owner activated S-00A through S-00E for v3.2.1 delivery to integration. | Execute the assigned vertical slice, verify acceptance, and review the immutable v3.2.1 candidate before integration. |
| [S-00D](workbench/specs/S-00D-genesis-from-blueprint-and-adrs/SPEC.md) | TK-00E: Derive a valid scoped room from locked project inputs (ready) | codex-v321-manager | S-00C | Owner activated S-00A through S-00E for v3.2.1 delivery to integration. | Execute the assigned vertical slice, verify acceptance, and review the immutable v3.2.1 candidate before integration. |
