...
| [S-021](specs/S-021-portable-workbench-v3/SPEC.md) | TK-005: One v3 planning-to-delivery workflow resolves all project support paths through the manifest using the 12 bundled core skills (in-progress) | codex | TK-004 | TK-005 claimed by codex. | Close TK-005 with verification and documentation proof. |
