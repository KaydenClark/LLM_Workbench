...
| [S-00E](workbench/specs/S-00E-fresh-template-project-proof/SPEC.md) | TK-00F: Exercise the clean-copy path through useful project continuation (in-progress) | codex-v321-manager | S-00D | TK-00F claimed by codex-v321-manager. | Close TK-00F with verification and documentation proof. |
