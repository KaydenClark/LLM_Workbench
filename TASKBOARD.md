...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-008: Record the declared context unit in the manifest (in-progress) | DISPATCHER | TT-Q10 (identifier form) is open and blocks TK-003 and TK-004. | TK-008 claimed by DISPATCHER. | Close TK-008 with verification and documentation proof. |
