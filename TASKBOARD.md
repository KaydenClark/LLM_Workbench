...
| [S-029](workbench/specs/S-029-declared-integration-branch/SPEC.md) | TK-003: `complete-on-integration` attention finding when the selected spec is complete at the declared integration ref (ready) | claude-fable-5-1 | TK-001 | TK-002 closed with proof. | Complete TK-003. |
