...
| [S-020](specs/S-020-spec-native-team-coordination/SPEC.md) | TK-004: Prove a two-lane bounded team demo and consolidate one durable checkpoint (in-progress) | codex/s020-tk004 | none | TK-004 claimed by codex/s020-tk004. | Close TK-004 with verification and documentation proof. |
<!-- hot-specs:end -->
