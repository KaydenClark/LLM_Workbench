...
- **Shipping now:** T-005-T-009 complete (templates copy-ready), plus T-012 - `ADOPTION.md`, a migration protocol for existing projects on an older harness. PRs #10-#15 stacked and awaiting owner merge.
...
- **Blocked on:** nothing; PRs #10 (T-006) -> #11 (T-009) -> #12 (T-007) -> #13 (T-005) -> #14 (T-008) -> #15 (T-012) await owner merge in stack order.
