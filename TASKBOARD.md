...
| [S-021](specs/S-021-portable-workbench-v3/SPEC.md) | TK-004: An explicitly requested v2 upgrade backs up changed skills, synchronizes the core, migrates legacy paths once, and proves rollback (ready) | codex | TK-003 | TK-003 closed with proof. | Complete TK-004. |
