...
| [S-036](workbench/specs/S-036-v3-1-2-evidence-corrections/SPEC.md) | TK-004: Reconcile current ownership prose, run the full release gate, independently review the immutable candidate, and land it on `integration` (in-progress) | codex-gpt-5 | TK-003 | Independent review of `72c5064` requested changes; the four reproduced gaps are corrected and focused green at `b2f802b`. | Run the full release gate and obtain fresh independent approval of the corrected immutable candidate. |
<!-- hot-specs:end -->
