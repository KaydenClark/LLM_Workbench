...
| [S-00B](workbench/specs/S-00B-workbench-template-reformation/SPEC.md) | TK-00C: Update and validate the Workbench Template against the settled ownership model (in-progress) | codex | S-00A | TK-00C claimed by codex. | Close TK-00C with verification and documentation proof. |
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | Acceptance / owner gate | codex | none | TK-007 closed with proof. | Confirm acceptance criteria and completion result. |
...
| [S-051](workbench/specs/S-051-core-skill-ownership-and-compatibility/SPEC.md) | Acceptance / owner gate | codex | none | TK-006 closed with proof. | Confirm acceptance criteria and completion result. |
