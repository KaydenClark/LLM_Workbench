...
| [S-047](workbench/specs/S-047-visible-workbench-identifiers/SPEC.md) | TK-002: Extend visible-ID compatibility through spec ticket and ADR consumers without renaming historical paths (in-progress) | codex | TK-001 | TK-002 claimed by codex. | Close TK-002 with verification and documentation proof. |
