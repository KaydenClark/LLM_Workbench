...
| [S-023](workbench/specs/S-023-manifest-schema-2-and-managed-runtime/SPEC.md) | TK-002: Runtime tools live in `workbench/tools/` with a receipt, install/verify/update/rollback work against a fixture project, and every consumer resolves the tools lane (ready) | claude-fable-5-1 | TK-001 | TK-001 closed with proof. | Complete TK-002. |
