...
| [S-00H](workbench/specs/S-00H-task-artifact-and-terminology-migration/SPEC.md) | TK-004: Update `to-tickets`, the skills/controls that instruct the old model, and every generic template mirror (in-progress) | DISPATCHER | TK-003 | TK-007 claimed by DISPATCHER. | Close TK-007 with verification and documentation proof. |
