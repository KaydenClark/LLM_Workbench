...
|---|---|---|---|---|---|
| [S-017](specs/S-017-controlled-outcome-measurement/SPEC.md) | TK-003: Aggregate multiple tasks into an uncertainty-aware no-spend report (in-progress) | codex-engineer | none | TK-003 exact-head Auditor findings were remediated with canonical eligibility, same-task equal weighting, and input deduplication. | Push the remediated TK-003 checkpoint and rerun the exact-head Auditor before close. |
