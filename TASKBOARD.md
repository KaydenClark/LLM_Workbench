...
| [S-051](workbench/specs/S-051-core-skill-ownership-and-compatibility/SPEC.md) | TK-003: Compose portable save and promote into a self-sufficient bundle (in-progress) | codex | TK-002 | TK-003 claimed by codex. | Close TK-003 with verification and documentation proof. |
| [S-052](workbench/specs/S-052-private-session-transport/SPEC.md) | TK-002: Synchronize selected safe notes and report acknowledgment (ready) | codex | TK-001 | TK-001 closed with proof. | Complete TK-002. |
