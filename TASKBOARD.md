...
| [S-036](workbench/specs/S-036-v3-1-2-evidence-corrections/SPEC.md) | TK-004: Reconcile current ownership prose, run the full release gate, independently review the immutable candidate, and land it on `integration` (in-progress) | codex-gpt-5 | TK-003 | Review of `ef22d38` found one remaining template-preflight gap and one stale Runbook sentence; both are corrected and focused green at `72ce55c`. | Rerun the full release gate and obtain fresh independent approval of the new exact candidate. |
<!-- hot-specs:end -->
