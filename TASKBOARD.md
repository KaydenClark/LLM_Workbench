...
| [S-023](workbench/specs/S-023-manifest-schema-2-and-managed-runtime/SPEC.md) | TK-004: Genesis and its templates produce a validated schema 2 project with a tools receipt, sessions ignore file, and design-concepts collection (ready) | claude-fable-5-1 | TK-003 | TK-003 closed with proof. | Complete TK-004. |
