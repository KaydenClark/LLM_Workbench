...
| [S-046](workbench/specs/S-046-json-notepad-foundation/SPEC.md) | TK-002: One agent saves an objective finding with a correction, then a fresh reader retrieves only that topic through the shared skill, schema, and CLI (ready) | codex | TK-001 | TK-001 closed with proof. | Complete TK-002. |
