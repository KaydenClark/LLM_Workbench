...
| [S-049](workbench/specs/S-049-assignment-ownership-and-coordination-record/SPEC.md) | TK-002: One real assignment is carried under `/carry`, and its hand-backs - or the recorded absence of any - are the first measurement (ready) | claude | owner decision on which version carries the seventeen-skill bundle | TK-001 built and green at `a617359`, then blocked: `main` already carries a sixteen-skill v3.1.2 manifest, so growing the bundle inside v3.1.2 redefines a shipped version. | Owner picks the version that carries the seventeen-skill bundle; TK-001 then closes and TK-002 waits on a real assignment. |
